          ...
          <div className="flex flex-col px-4 py-4 space-y-4 md:px-8 lg:px-16">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <input
                ...
                type="email"
                id="email"
                className="w-full px-4 py-2 bg-gray-200 border rounded cursor-not-allowed focus:outline-none focus:cursor-not-allowed"
              />
            ...
            <div
              ...
              className="w-full px-4 py-2 text-center text-gray-100 rounded cursor-pointer"
            >
              Update Information
            </div>
          </div>
