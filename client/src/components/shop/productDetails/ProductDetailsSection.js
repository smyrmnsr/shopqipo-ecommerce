        ...
        <div className="grid grid-cols-2 md:grid-cols-12">
          <div className="hidden md:block md:col-span-1 md:flex md:flex-col md:space-y-4 md:mr-2">
            <img
              ...
              className={`${
                count === 0 ? "" : "opacity-25"
              } cursor-pointer w-20 h-20 object-cover object-center rounded`}
          ...
          <div className="col-span-2 mt-8 md:mt-0 md:col-span-4 md:ml-6 lg:ml-12">
            ...
            <div className="my-4 md:my-6">
              ...
              <div
                className={`flex justify-between items-center rounded px-4 py-2 border rounded-t-lg ${
                ...
                <Fragment>
                  ...
                  layoutData.inCart.includes(sProduct._id) === true ? (
                    ...
                    <div
                      ...
                      style={{ background: "#303031" }}
                      className={`px-4 py-2 text-white text-center cursor-pointer uppercase rounded-b-lg`}
                    >
                      Add to cart
                    </div>
                  )}
