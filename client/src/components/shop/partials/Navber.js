  ...
  return (
    <Fragment>
      ...
      <nav
        ...
        className="fixed top-0 z-10 w-full shadow-lg lg:shadow-none hover:bg-gray-900">
        <div className="grid grid-cols-4 m-4 md:mx-12 md:my-6 lg:grid-cols-3">
          <div className="flex hidden col-span-1 py-3 mt-1 text-gray-600 lg:block">
            <span
              className="px-4 py-3 text-lg font-medium tracking-wider rounded-lg cursor-pointer hover:text-yellow-700"
              onClick={(e) => history.push("/")}
            >
              Shop
            </span>
            {/* <span
              className="px-4 py-3 font-light tracking-widest rounded-lg cursor-pointer hover:bg-gray-200 hover:text-purple-700"
          ...
          <div className="flex items-center col-span-2 lg:hidden justify-items-stretch">
            ...
            <span
              ...
              className="flex px-2 text-2xl text-center text-yellow-700 cursor-pointer font-comfortaa items-left"
            >
              shopqipo
            </span>
          </div>
          <div
            ...
            className="flex hidden col-span-1 text-4xl tracking-normal text-center text-yellow-700 cursor-pointer font-comfortaa lg:block items-left"
          >
            shopqipo
          </div>
          <div className="flex justify-end col-span-2 items-right lg:col-span-1">
            ...
            <div
              ...
              className="px-2 py-2 rounded-lg cursor-pointer hover:text-black"
              title="Wishlist"
            >
              <svg
                className={`${location.pathname === "/wish-list"
                    ...
                    : ""
                  } w-8 h-8 text-gray-600 hover:text-yellow-700 cursor-pointer`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
            ...
            {localStorage.getItem("jwt") ? (
              <Fragment>
                ...
                >
                  <svg
                    className="w-8 h-8 text-gray-600 cursor-pointer hover:text-yellow-700"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <svg
                  className="w-8 h-8 text-gray-600 hover:text-yellow-700"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              ...
              className="relative px-2 py-2 rounded-lg cursor-pointer"
              title="Cart"
            >
              <svg
                className="w-8 h-8 text-gray-600 hover:text-yellow-700"
        ...
        >
          <div className="flex flex-col col-span-1 text-gray-400">
            <span
              className="px-3 py-2 text-lg font-medium tracking-widest rounded-lg cursor-pointer hover:text-black hover:bg-gray-200"
              onClick={(e) => history.push("/")}
            >
              Shop
            </span>
