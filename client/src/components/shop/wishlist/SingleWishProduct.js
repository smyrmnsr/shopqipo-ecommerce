              ...
              >
                <div className="md:w-1/2 md:flex md:items-center">
                  <img
                    ...
                    className="cursor-pointer rounded-md md:h-20 md:w-20 object-cover object-center"
                ...
                <div className="md:w-1/2 md:flex md:items-center md:justify-around">
                  ...
                  <div
                    ...
                    onClick={(e) => history.push(`/products/${product._id}`)}
                    className="inline-block px-4 py-2 text-white text-xs rounded-md md:text-base text-center cursor-pointer hover:opacity-75"
                  >
                    View
                  </div>
                </div>
