  ...
  return (
    <Fragment>
      <div className="relative p-4 m-4 bg-white shadow-lg">
        ...
        <div className="relative flex flex-col space-y-2 cursor-pointer">
          <div
            style={{ background: "#303031" }}
            className="relative z-0 flex justify-center px-4 py-2 space-x-2 text-white rounded cursor-pointer md:w-4/12"
          >
            <svg
              className="w-6 h-6"
              fill="none"
          ...
          <input
            ...
            className="absolute z-10 bg-gray-100 opacity-0 cursor-pointer"
            type="file"
            id="image"
          />
        </div>
